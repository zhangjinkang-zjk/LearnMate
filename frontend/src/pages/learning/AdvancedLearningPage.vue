<template>
  <div class="advanced-page">
    <PageTitle eyebrow="应用实践 · 进阶学习" title="先选择要解决的问题" description="实践任务每完成 10 个基础学习节点更新一次。先看清任务和依据，再进入学习巩固与 LearnMate 一起推演方案。">
    ...
    <template v-else>
      ...
      <section class="task-catalog"><div class="catalog-heading"><div><p class="eyebrow">实践任务目录</p><h2>也可以从这里换一个入口</h2></div><span>第 {{ milestone.current }} 个里程碑 · {{ tasks.length }} 个可选任务</span></div><div class="catalog-grid" role="list">
