...
.test-gate { display: flex; align-items: flex-start; gap: 14px; margin-bottom: 18px; color: var(--accent-deep); }.test-gate > div { flex: 1; }.test-gate .eyebrow { margin: 0 0 6px; }.test-gate h2 { margin: 0; font-size: 18px; color: var(--ink); }.test-gate p:last-child { max-width: 760px; margin: 7px 0 0; color: var(--muted); font-size: 12px; line-height: 1.7; }.test-gate .button { flex: 0 0 auto; margin-top: 4px; }
...
@media (max-width: 680px) { .test-context { align-items: stretch; flex-direction: column; }.chapter-picker { flex-basis: auto; }.test-gate { flex-direction: column; }.test-gate .button { width: 100%; margin-top: 0; }.test-tabs { grid-template-columns: 1fr; } }
</style>
