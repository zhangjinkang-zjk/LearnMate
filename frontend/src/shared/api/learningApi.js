...
export const learningApi = {
  ...
  generatePathsFromDirection: (direction = '', goal = '') => httpClient.post('/path/generate-from-direction', { direction, goal, subject_limit: 4, difficulty: 'medium', node_count: 0 }, { timeout: 300000 }),
